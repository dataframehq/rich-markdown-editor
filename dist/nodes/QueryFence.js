...
class QueryFence extends Node_1.default {
    constructor() {
        super(...arguments);
    ...
    get schema() {
        return {
            ...
            toDOM: (node) => {
                ...
                return [
                    "div",
                    { class: "query-block", "data-language": node.attrs.language },
                    ["div", { contentEditable: false }, select, button],
                    ["pre", ["query", { spellCheck: false }, 0]],
                ];
            },
        };
    }
...
exports.default = QueryFence;
//# sourceMappingURL=QueryFence.js.map